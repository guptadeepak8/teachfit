...
export default function EmployeeTable({about}) {
  return (
    <div className='mt-4'>
      ...
      <table className="table-auto w-full">
        ...
        <tbody>
          {about && about.employees.map((employee)=>{
            return (
              ...
              <td className="px-4 py-2">{employee.Ename}</td>
              <td className="px-4 py-2">{employee.Eemail}</td>
              <td className="px-4 py-2">
