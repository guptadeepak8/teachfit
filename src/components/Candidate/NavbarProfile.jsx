      ...
      <div className="flex flex-row justify-around items-center bg-white p-3">
        ...
        <div className="flex gap-5 justify-center items-center">
          <button className="relative p-2 text-slate-500  hover:rounded-full hover:bg-blue-500 hover:text-white">
            ...
            <span className="absolute top-2 right-3 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full transform translate-x-1/2 -translate-y-1/2">3</span>
          </button>
          <button className=" p-2 text-slate-500  hover:rounded-full hover:bg-blue-500 hover:text-white">
